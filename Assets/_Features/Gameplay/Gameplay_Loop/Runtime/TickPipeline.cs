...
namespace Game.Feature.Gameplay.Loop
{
    public sealed partial class TickPipeline
    {
            ...
            ITileEffectResolver tileEffectResolver = null)
        {
            ...
            if (!playerFree2DLocomotion.IsConfigured)
            {
                throw new ArgumentException(
                    "TickPipeline requires compiled Player Free2D locomotion settings from the composition boundary.",
                    nameof(playerFree2DLocomotion));
            }

            _playerFree2DLocomotion = playerFree2DLocomotion;
            ...
            out string reason)
        {
            ...
            {
                reason = "PlayerOrdinaryMoveRejectedBeforeLegacyExpansion";
                return true;
            }
            ...
            FinalizationBatch batch)
        {
            ...
            if (PlayerControlQueries.HasQueuedFree2DAction(effectivePlayerControlState))
            {
            ...
            HashSet<int> consumedPlayerActionAttemptEntityIds)
        {
            ...
            for (var i = 0; i < entities.Count; i++)
            {
                ...
                if (snapshot.TryGetUnitContinuousLocomotionPose(entity.entityId, out var free2DPose) &&
                ...
                if (!TryCreatePlayerActionAttemptResolution(
                        ...
                        snapshot.TryGetUnitContinuousLocomotionPose(entity.entityId, out free2DPose)
                            ? free2DPose
                            : null,
                        _playerFree2DLocomotion.ActionAssistSettleWindowUnits,
            ...
            int damageAmount)
        {
            ...
            {
                var playerInterrupt = interruptPlayerMotion && hasPlayerControl;
