...
namespace Game.Feature.Gameplay.Vfx.Host
{
    ...
    public sealed class GameplayVfxProductionRuntime : MonoBehaviour, IGameplayTickPresentationExtension, IGameplayInitialPresentationExtension, IGameplayOutputCameraPresentationExtension, IGameplayPresentationMotionVfxExtension, IGameplayDestroyShrinkVfxSequenceStateProvider, IGameplayTopologyTransitionCompletionPresentationExtension, IGameplayPresentationPausable, IGameplayStageTerminalPresentationExtension
    {
        ...
        {
            return IsCanonicalMigratedCue(cueId) ||
        ...
        private static bool IsCanonicalMigratedCue(GameplayVfxCueId cueId)
        {
            return cueId == GameplayVfxCueId.From(PlayerVfxCue.Damage) ||
                   ...
                   cueId == GameplayVfxCueId.From(EnemyVfxCue.FrontFaceShieldActive) ||
                   cueId == GameplayVfxCueId.From(EnemyVfxCue.FrontFaceShieldBlock) ||
                   cueId == GameplayVfxCueId.From(EnemyVfxCue.FrontFaceShieldWindup) ||
        ...
        private int ScheduleAfterEntityMotionBoxDestroyExitVfx(in GameplayTickPresentationExtensionContext context)
        {
            ...
            for (var i = 0; i < signals.Count; i++)
            {
                ...
                var playSmoke = CanonicalMigratedGameplayVfxEnabled;
                var playShrink = CanonicalMigratedGameplayVfxEnabled;
