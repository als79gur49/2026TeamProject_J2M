...
namespace Game.Feature.Gameplay.Tests.PlayMode
{
    public sealed class ActualSceneBootstrapSmokePlayModeTests
    {
        ...
        [UnityTest]
        [Category("Core")]
        public IEnumerator ActualSceneBootstrap_GameplayShellCombinedGameplayShowcaseStage_FirstFiveTicks_NoException()
        {
        ...
        [UnityTest]
        [Category("Core")]
        public IEnumerator ActualSceneBootstrap_GameplayShellTutorialStage_FirstFiveTicks_NoException()
        {
            yield return AssertSceneBootstrapFirstFiveTicks(
                UIAudioScenePath,
        ...
        [UnityTest]
        [Category("Core")]
        public IEnumerator ActualSceneBootstrap_GameplayShellStage0_1_ResolvesStageAndInstallsUiAudio()
        {
            yield return AssertSceneBootstrapFirstFiveTicks(
                UIAudioScenePath,
