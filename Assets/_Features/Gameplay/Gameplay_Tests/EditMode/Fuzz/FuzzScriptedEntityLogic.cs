...
{
    internal sealed class FuzzScriptedEntityLogic : IMovementEntityLogic, IAttackEntityLogic, IReplayTickAwareEntityLogic, IEntityLogicSourceBinding
    {
        ...
        public int ControlledEntityId => _script.EntityId;
