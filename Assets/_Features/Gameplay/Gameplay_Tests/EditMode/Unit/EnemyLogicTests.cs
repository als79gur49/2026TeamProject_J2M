...
namespace Game.Feature.Gameplay.Tests.Unit
{
    public sealed class EnemyLogicTests
    {
        ...
        [Test]
        [Category("Core")]
        public void EnemyUtilityEffectRuntime_RetiredLockNearbyBoxes_Throws()
        {
            var exception = Assert.Throws<ArgumentException>(
                () => new EnemyUtilityEffectRuntime(
                    EnemyUtilityEffectKind.RetiredLockNearbyBoxes,
                    initialDelayTicks: 0,
                    cooldownTicks: 1));
        ...
        [Test]
        [Category("Core")]
        public void EnemyAiProfileCompiler_UtilityCapability_RetiredLockNearbyBoxes_Throws()
        {
        ...
        private static CombatOriginAnchor CreateCombatOriginAnchor(SurfaceCell sourceCell, Direction facing)
        {
            return new CombatOriginAnchor(
                ...
                sourceCell.x * SimulationFixed.UnitsPerCell,
                sourceCell.y * SimulationFixed.UnitsPerCell,
                facing);
        }
