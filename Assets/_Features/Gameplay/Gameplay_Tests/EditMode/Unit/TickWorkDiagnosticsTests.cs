...
namespace Game.Feature.Gameplay.Tests.Unit
{
    public sealed class TickWorkDiagnosticsTests
    {
        [Test]
        [Category("Extended")]
        public void BuilderResultPath_BaselineRecordsOneEnumerationAndTwoDefensiveCopies()
        {
            ...
            Assert.That(counts.FinalEntityDefensiveCopyCount, Is.EqualTo(2));
            ...
            Assert.That(counts.TickResultFinalEntityTrustedShareCount, Is.Zero);
