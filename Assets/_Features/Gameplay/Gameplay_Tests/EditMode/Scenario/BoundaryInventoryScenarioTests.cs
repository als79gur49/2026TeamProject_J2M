...
namespace Game.Feature.Gameplay.Tests.Scenario
{
    public sealed class BoundaryInventoryScenarioTests
    {
        ...
        [Test]
        [Category("Core")]
        public void BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement()
        {
            AssertDefaultEnemyKinematicLocomotionFlags();
        ...
        [Test]
        [Category("Core")]
        public void DeprecationPhase1_DefaultEnemyKinematicLocomotion_PlayerEnemyCharge_NoLegacyFallback()
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement();
        }

        [Test]
        [Category("Core")]
        public void DeprecationPhase1_DefaultEnemyKinematicLocomotion_PlayerOrdinary_NoLegacyFallback()
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement();
        }
        ...
        [Test]
        [Category("Core")]
        public void DeprecationPhase1_DefaultEnemyKinematicLocomotion_EnemyOrdinary_NoLegacyFallback()
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement();
        }
        ...
        [Test]
        [Category("Core")]
        public void DeprecationPhase1_DefaultEnemyKinematicLocomotion_ChargeActive_NoLegacyFallback()
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement();
        }
        ...
        public void MoveOwnership_RemovedDiagnosticBaseline_NoCoveredEntityMove()
        {
            var playerTick = CreatePipeline(
                ...
                .RunTick(new TickInput(1, PlayerTickCommand.Move(Direction.Right)));
            LegacyMovementBoundaryAssert.PlayerOrdinaryMoveRejectedBeforeLegacyExpansion(playerTick, 10);
        ...
        [Test]
        [Category("Extended")]
        public void Phase2_RetiredPlayerOrdinaryFallback_DefaultEnemyKinematicLocomotion_NoLegacyFallback()
        {
            AssertDefaultEnemyKinematicLocomotionFlags();
            ...
            Assert.That(tick.PresentationData.ContinuousLocomotionTracks.Any(track => track.EntityId == 10), Is.True);
            LegacyMovementBoundaryAssert.NoRetiredPlayerOrdinaryFallback(tick, 10);
            LegacyMovementBoundaryAssert.LegacyFallbackIsOnlyForAllowedEntities(tick);
        }

        [Test]
        [Category("Extended")]
        public void Phase2_PlayerOrdinaryMove_DefaultGameplay_BlockedBeforeMovementExpander()
        {
        ...
        public void Phase2_RetiredPlayerOrdinaryFallback_FlagOffBaseline_RemovedByPhase4()
        {
        ...
        [Test]
        [Category("Extended")]
        public void Phase4_RemovedDiagnosticBaseline_PlayerFallbackRemoved()
        {
            var tick = CreatePipeline(
                    CreateWorldState(new[] { CreatePlayer(10, new SurfaceCell(FaceId.Floor, 0, 0)) }),
                    new IEntityLogic[] { new PlayerLogic(10), new PlayerControlStateLogic(10) },
            ...
            LegacyMovementBoundaryAssert.PlayerOrdinaryMoveRejectedBeforeLegacyExpansion(tick, 10);
            LegacyMovementBoundaryAssert.LegacyFallbackIsOnlyForAllowedEntities(tick);
        }

        [Test]
        [Category("Extended")]
        public void Phase2_RetiredPlayerOrdinaryFallback_TopologyHandoff_IsRetainedGridTransaction()
        {
        ...
        {
            Phase2_RetiredPlayerOrdinaryFallback_DefaultEnemyKinematicLocomotion_NoLegacyFallback();
        }
        ...
        {
            Phase2_RetiredPlayerOrdinaryFallback_TopologyHandoff_IsRetainedGridTransaction();
        }
        ...
        [Test]
        [Category("Extended")]
        public void Phase2B_EnemyLegacyFallback_DefaultEnemyKinematicLocomotion_NoLegacyFallback()
        {
            AssertDefaultEnemyKinematicLocomotionFlags();
        ...
        {
            Phase2B_EnemyLegacyFallback_DefaultEnemyKinematicLocomotion_NoLegacyFallback();
        }
        ...
        [Test]
        [Category("Extended")]
        public void Phase5_RemovedDiagnosticBaseline_EnemyFallbackRemoved()
        {
            var tick = CreatePipeline(
                    CreateWorldState(new[] { CreateUnit(40, 2, new SurfaceCell(FaceId.Floor, 0, 0), aiMode: EnemyAiMode.Chase) }),
                    new IEntityLogic[] { new ScriptedMovementLogic(1, new RawMovementIntent(40, 50, new Vector2Int(1, 0))) },
        ...
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_GlideActiveKinematic();
        }
        ...
        [Test]
        [Category("Extended")]
        public void Phase2C_ChargeLegacyFallback_DefaultEnemyKinematicLocomotion_NoChargeMoveFallback()
        {
            AssertDefaultEnemyKinematicLocomotionFlags();
        ...
        {
            Phase2C_ChargeLegacyFallback_DefaultEnemyKinematicLocomotion_NoChargeMoveFallback();
        }
        ...
        [Test]
        [Category("Extended")]
        public void Phase6_RemovedDiagnosticBaseline_ChargeFallbackRemoved()
        {
            var worldState = CreateActiveChargeWorldState(50);
            var tick = CreatePipeline(
                    worldState,
        ...
        [Test]
        [Category("Core")]
        public void BoundaryInventory_GridTransactionsRemainAllowed_UnderDefaultEnemyKinematicLocomotion()
        {
        ...
        [Test]
        [Category("Core")]
        public void Phase3_DefaultEnemyKinematicLocomotion_NoCoveredFallback()
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement();
        }
        ...
        {
            BoundaryInventory_GlideFlagOff_FallbackStillRetained();
            DefaultEnemyKinematicLocomotion_IncludesGlideKinematic();
        }
        ...
        {
            BoundaryInventory_GridTransactionsRemainAllowed_UnderDefaultEnemyKinematicLocomotion();
        }
        ...
        public void Phase7_LegacyFallbackBaseline_IsDiagnosticCompatibilityPreset()
        {
            var playerTick = CreatePipeline(
                    ...
                    GameplayRuntimeFeatureFlags.RemovedLegacyFallbackDiagnosticBaseline)
                .RunTick(new TickInput(1, PlayerTickCommand.Move(Direction.Right)));
            LegacyMovementBoundaryAssert.AssertPlayerOrdinaryMoveRejectedBeforeLegacyExpansion(playerTick, 10);
            LegacyMovementBoundaryAssert.LegacyFallbackIsOnlyForAllowedEntities(playerTick);
        ...
        public void Phase7_HelperNames_AreCurrent()
        {
            var canonicalHelperNames = new[]
            {
                ...
                nameof(LegacyMovementBoundaryAssert.AssertPlayerOrdinaryMoveRejectedBeforeLegacyExpansion),
            ...
            Assert.That(phase7ReportStrings, Does.Contain("RemovedLegacyFallbackDiagnosticBaseline: diagnostic compatibility preset"));
        }
        ...
        public void Phase8A_LegacyFallbackBaseline_IsDiagnosticCompatibilityNaming()
        {
            ...
            Assert.That(currentVocabulary, Does.Contain("RemovedLegacyFallbackDiagnosticBaseline: diagnostic compatibility preset"));
        ...
        public void FallbackWrapperCleanup_CurrentPolicyTests_UseRemovedDiagnosticVocabulary()
        {
            ...
            var forbiddenCurrentPolicyPhrases = new[]
            {
                ...
                "RemovedLegacyFallbackDiagnosticBaseline " + "allows",
            };
            ...
            Assert.That(scenarioSource, Does.Contain(nameof(LegacyMovementBoundaryAssert.AssertPlayerOrdinaryMoveRejectedBeforeLegacyExpansion)));
        ...
        public void FallbackWrapperCleanup_HistoricalCanaries_AreExplicitlyMarked()
        {
            ...
            var playerReplaySource = ReadRepoFile("Assets/_Features/Gameplay/Gameplay_Tests/EditMode/Replay/PlayerFree2DLocomotionReplayTests.cs");
        ...
        public void Phase8C_RemovedDiagnosticBaseline_IsCanonicalUsage()
        {
            ...
            var phase8CVocabulary = new[]
            {
                ...
                "RemovedDiagnosticBaselineAlias: removed compatibility alias",
                "covered fallback authorization: removed",
            };
        ...
        public void Phase8C_CurrentPolicyDocs_UseRemovedDiagnosticBaseline()
        {
            ...
            {
                Assert.That(doc, Does.Contain("RemovedLegacyFallbackDiagnosticBaseline"));
                Assert.That(doc, Does.Not.Contain("RemovedDiagnosticBaselineAlias allows fallback"));
                Assert.That(doc, Does.Not.Contain("RemovedDiagnosticBaselineAlias is the baseline"));
                Assert.That(doc, Does.Not.Contain("Legacy fallback baseline remains allowed"));
            }

            Assert.That(
                docs.Any(doc => doc.Contains(
                    "RemovedDiagnosticBaselineAlias` remains a deprecated compatibility alias",
        ...
        [Test]
        [Category("Core")]
        public void Phase8C_RemovedDiagnosticBaselineAlias_IsRemoved()
        {
            ...
            var sourceFilesWithoutOldAliasDirectUsage = new[]
            {
                ...
                "Assets/_Features/Gameplay/Gameplay_Tests/EditMode/Replay/PlayerFree2DLocomotionReplayTests.cs",
            };

            Assert.That(
                runtimeFlags,
                Does.Not.Contain("RemovedDiagnosticBaselineAlias"));
            ...
            foreach (var relativePath in sourceFilesWithoutOldAliasDirectUsage)
            {
                ...
                Assert.That(
                    source,
                    Does.Not.Contain("GameplayRuntimeFeatureFlags.RemovedDiagnosticBaselineAlias"),
                    relativePath);
            }
        }
        ...
        public void Phase8D_RemovedLegacyFallbackDiagnosticsEnabled_IsCanonicalHelper()
        {
            ...
            var phase8DVocabulary = new[]
            {
                ...
                "RemovedDiagnosticHelperAlias: removed compatibility alias",
                "covered fallback authorization: removed",
            };
            ...
            foreach (var preset in presets)
            {
                Assert.That(
                    ...
                    Is.EqualTo(preset.Equals(GameplayRuntimeFeatureFlags.RemovedLegacyFallbackDiagnosticBaseline)));
            }

            Assert.That(GameplayRuntimeFeatureFlags.None.RemovedLegacyFallbackDiagnosticsEnabled, Is.False);
            Assert.That(GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion.RemovedLegacyFallbackDiagnosticsEnabled, Is.False);
            Assert.That(GameplayRuntimeFeatureFlags.AllEnemyKinematicLocomotionEnabled.RemovedLegacyFallbackDiagnosticsEnabled, Is.False);
        ...
        [Test]
        [Category("Core")]
        public void Phase8D_RemovedDiagnosticHelperAlias_IsRemoved()
        {
            var runtimeFlags = ReadRepoFile("Assets/_Features/Gameplay/Gameplay_Loop/Runtime/GameplayRuntimeFeatureFlags.cs");
            ...
            Assert.That(
                runtimeFlags,
                Does.Not.Contain("RemovedDiagnosticHelperAlias"));
            Assert.That(tickPipeline, Does.Contain("RemovedLegacyFallbackDiagnosticsEnabled"));
            Assert.That(tickPipeline, Does.Not.Contain("RemovedDiagnosticHelperAlias"));

            foreach (var relativePath in sourceFilesWithoutOldHelperUsage)
            {
                var source = ReadRepoFile(relativePath);
                Assert.That(source, Does.Not.Contain("RemovedDiagnosticHelperAlias"), relativePath);
            }
        }
        ...
        public void Phase8D_CurrentPolicyDocs_UseRemovedDiagnosticHelper()
        {
            ...
            foreach (var doc in docs)
            {
                ...
                Assert.That(doc, Does.Not.Contain("RemovedDiagnosticHelperAlias allows fallback"));
                Assert.That(doc, Does.Not.Contain("RemovedDiagnosticHelperAlias is the helper"));
            }

            Assert.That(
                docs.Any(doc => doc.Contains(
                    "RemovedDiagnosticHelperAlias` remains a deprecated compatibility alias",
                    StringComparison.Ordinal)),
                Is.False);
        }
        ...
        [Test]
        [Category("Core")]
        public void Phase8E_RemovedLegacyFallbackDiagnosticsEnabled_IsCanonicalField()
        {
            var removedDiagnosticField = typeof(GameplayRuntimeFeatureFlags).GetProperty(
                nameof(GameplayRuntimeFeatureFlags.RemovedLegacyFallbackDiagnosticsEnabled),
            ...
            {
                "RemovedLegacyFallbackDiagnosticsEnabled: canonical removed-fallback diagnostics field",
                "covered fallback authorization: removed",
            };

            Assert.That(removedDiagnosticField, Is.Not.Null);
            foreach (var preset in presets)
            {
                Assert.That(
                    preset.RemovedLegacyFallbackDiagnosticsEnabled,
            ...
            Assert.That(GameplayRuntimeFeatureFlags.AllEnemyKinematicLocomotionEnabled.RemovedLegacyFallbackDiagnosticsEnabled, Is.False);
            Assert.That(GameplayRuntimeFeatureFlags.RemovedLegacyFallbackDiagnosticBaseline.RemovedLegacyFallbackDiagnosticsEnabled, Is.True);
            Assert.That(phase8EVocabulary, Does.Contain("RemovedLegacyFallbackDiagnosticsEnabled: canonical removed-fallback diagnostics field"));
            Assert.That(phase8EVocabulary.Any(text => text.Contains("fallback allowed", StringComparison.Ordinal)), Is.False);
        }

        [Test]
        [Category("Core")]
        public void Phase8E_RemovedDiagnosticField_RemainsNotSceneConfigExposed()
        {
            ...
            Assert.That(
                ...
                Does.Not.Contain(nameof(GameplayRuntimeFeatureFlags.RemovedLegacyFallbackDiagnosticsEnabled)));
            Assert.That(
        ...
        [Test]
        [Category("Core")]
        public void Phase8E_RemovedDiagnosticField_IsCanonicalApi()
        {
            var runtimeFlags = ReadRepoFile("Assets/_Features/Gameplay/Gameplay_Loop/Runtime/GameplayRuntimeFeatureFlags.cs");
            var tickPipeline = ReadRepoFile("Assets/_Features/Gameplay/Gameplay_Loop/Runtime/TickPipeline.cs");

            Assert.That(runtimeFlags, Does.Contain("public bool RemovedLegacyFallbackDiagnosticsEnabled { get; }"));
        ...
        [Test]
        [Category("Core")]
        public void Phase8E_TraceToken_UsesCanonicalRemovedDiagnosticVocabulary()
        {
            var tickPipeline = ReadRepoFile("Assets/_Features/Gameplay/Gameplay_Loop/Runtime/TickPipeline.cs");
            ...
            Assert.That(tickPipeline, Does.Contain("RemovedLegacyFallbackDiagnosticsEnabled="));
            Assert.That(tickPipeline, Does.Contain("_runtimeFeatureFlags.RemovedLegacyFallbackDiagnosticsEnabled"));
            Assert.That(phase8EDoc, Does.Contain("Trace vocabulary now uses `RemovedLegacyFallbackDiagnosticsEnabled=`."));
            Assert.That(phase8EDoc, Does.Contain("No compatibility trace projection is retained."));
        }

        [Test]
        [Category("Core")]
        public void Phase8E_ImmediateDeletionDecision_IsDocumented()
        {
            var phase8EDoc = ReadRepoFile(
                "Docs/Testing/Legacy-Ordinary-Unit-Movement-Deprecation-Phase8E-Underlying-Field-Readiness-2026-05-02.md");

            Assert.That(phase8EDoc, Does.Contain("C안 immediate deletion is complete."));
            Assert.That(phase8EDoc, Does.Contain("RemovedLegacyFallbackDiagnosticsEnabled is the canonical runtime flag."));
            Assert.That(phase8EDoc, Does.Not.Contain("compatibility wrapper is retained"));
        }
        ...
        [Test]
        [Category("Core")]
        public void ScopedDeletionPrep_RetiredPlayerOrdinaryFallback_RemovedByPhase4()
        {
            var flagOffTick = CreatePipeline(
                    ...
                    GameplayRuntimeFeatureFlags.RemovedLegacyFallbackDiagnosticBaseline)
                .RunTick(new TickInput(1, PlayerTickCommand.Move(Direction.Right)));
            LegacyMovementBoundaryAssert.PlayerOrdinaryMoveRejectedBeforeLegacyExpansion(flagOffTick, 10);
            ...
            LegacyMovementBoundaryAssert.NoCoveredFallbackInDefaultEnemyKinematicLocomotion(defaultTick, 10);
        ...
        public void ScopedDeletionPrep_EnemyLegacyFallback_RemovedByPhase5()
        {
            ...
            LegacyMovementBoundaryAssert.NoCoveredFallbackInDefaultEnemyKinematicLocomotion(defaultTick, 40);
        ...
        public void ScopedDeletionPrep_ChargeLegacyFallback_RemovedByPhase6()
        {
            ...
            Assert.That(
                defaultTick.PresentationData.KinematicMotionTracks.Any(track =>
                    ...
                    track.MotionMode == MotionMode.Charge),
                Is.True);
            LegacyMovementBoundaryAssert.NoCoveredFallbackInDefaultEnemyKinematicLocomotion(defaultTick, 50);
        ...
        [Test]
        [Category("Core")]
        public void BoundaryInventory_DefaultEnemyKinematicLocomotion_GlideActiveKinematic()
        {
        ...
        public void BoundaryInventory_GlideChaserAsset_DefaultGameplay_AllowsActiveGliderSolidOverlap()
        {
            ...
            Assert.That(GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion.EnableEnemyGlideKinematicLocomotion, Is.True);
        ...
        public void DefaultEnemyKinematicLocomotion_IncludesGlideKinematic()
        {
            var flags = GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion;
            ...
            Assert.That(GameplayRuntimeFeatureFlags.AllEnemyKinematicLocomotionEnabled.EnableEnemyGlideKinematicLocomotion, Is.True);
        }
        ...
        [Test]
        [Category("Core")]
        public void ScopedDeletionPrep_DefaultEnemyKinematicLocomotion_NoCoveredLegacyPresentation()
        {
            BoundaryInventory_DefaultEnemyKinematicLocomotion_NoLegacyOrdinaryUnitMovement();
        }
        ...
        public void LegacyOrdinaryUnitMovement_DeprecationReadiness_Report()
        {
            ...
            {
                "player ordinary move: rejected before legacy expansion",
            ...
            {
                GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion.EnableEnemySameFaceContinuousLocomotion,
                GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion.EnableEnemyChargeKinematicLocomotion,
                GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion.EnableEnemyGlideKinematicLocomotion,
            };
        ...
        private static void AssertDefaultEnemyKinematicLocomotionFlags()
        {
            var flags = GameplayRuntimeFeatureFlags.DefaultEnemyKinematicLocomotion;
        ...
        private static UnitKinematicLocomotionTimingSnapshot CreateTwoTickKinematicTiming()
        {
            ...
            {
                MoveDurationSeconds = 2f / timingProfile.SimulationTicksPerSecond,
