...
namespace Game.Feature.Gameplay.Tests.Scenario
{
    public sealed class FlipB1HostileImpactScenarioTests
    {
        ...
        [Test]
        [Category("B1Future")]
        [Ignore("B1 future: expected to fail until hostile impact execute branch schedules due contacts instead of same-tick impact reservations.")]
        ...
        [Test]
        [Category("B1Future")]
        [Ignore("B1 future: expected to fail until hostile impact execute branch schedules due contacts.")]
        ...
        [Test]
        [Category("B1Future")]
        [Ignore("B1 future: expected to fail until hostile impact execute branch puts the source box in flight.")]
        ...
        [Test]
        [Category("B1Future")]
        [Ignore("B1 future: expected to fail until damage is deferred to the due contact tick.")]
        ...
        [Test]
        [Category("B1Future")]
        [Ignore("B1 future: expected to fail until target death is deferred to the due contact tick.")]
        ...
        [Test]
        [Category("B1Future")]
        [Ignore("B1 future: expected to fail until target removal is deferred to the due contact tick.")]
