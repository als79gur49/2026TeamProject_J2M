    ...
    public sealed class TileFeatureOverlayArchitectureTests
    {
        ...
        public void GravityFieldLockedTargetPolicy_DocumentsReadModelAndLockedBoxOneShotScope()
        {
            ...
            var requiredSnippets = new[]
            {
                ...
                "The lockable box shader computes an opaque noise-based albedo tint reveal",
        ...
        public void TileFeatureOverlayGate_DocumentsImplementedBarricadeMovementBlockerPolicy()
        {
            ...
            var requiredSnippets = new[]
            {
                ...
                "if a topology-active/effective-active Barricade has a same-cell valid Box Solid occupant and no live Unit suppressor, the Box is crushed even without a new inactive-to-active transition.",
                ...
                "`BarricadeCrushed` is sourced from actual Barricade crush operations",
