...
namespace Game.Feature.Stages
{
    public enum SceneTransitionIntent
    {
        ...
        GameplayEntry = 4,
        ReturnToMainMenu = 5,
        CinematicToGameplay = 6,
        CinematicToMainMenu = 7,
        DemoStageRelaunch = 8,
    ...
    public static class SceneTransitionRoutePolicyCatalog
    {
        private static readonly SceneTransitionRoutePolicy[] Policies =
        {
            ...
            Production(
                ...
                SceneTransitionRouteStatus.Canonical,
                StageTransitionKind.MainToGameplay,
                owner: "CinematicStageLaunchRouter / GameplayUiFlowInstaller",
                currentExecution: "Rendered cinematic black -> rendered persistent black -> gameplay readiness -> rendered black Entry Iris -> opening",
                migrationMilestone: "M4 complete",
                implementsSession: true,
                implementsReadiness: true,
                implementsRenderAcknowledgement: true,
            ...
            Production(
                ...
                SceneTransitionRouteStatus.Canonical,
                StageTransitionKind.GameplayToMain,
                owner: "CinematicMainMenuReturnRouter / MainMenuUiFlowInstaller",
                currentExecution: "Rendered cinematic black -> rendered persistent black -> Main Menu readiness -> rendered closed menu Iris -> opening",
                migrationMilestone: "M4 complete",
                implementsSession: true,
                implementsReadiness: true,
                implementsRenderAcknowledgement: true,
