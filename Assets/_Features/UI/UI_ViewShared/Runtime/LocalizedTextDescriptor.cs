    ...
    public sealed class PackageFreeLocalizedTextResolver : ILocalizedTextResolver, IUiLocaleSelectionPort
    {
        ...
        private static IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> CreateSettingsCatalog()
        {
            var catalog = new Dictionary<string, IReadOnlyDictionary<string, string>>
            {
                [DefaultLocaleCode] = new Dictionary<string, string>
                {
                    ...
                    [SettingsLocalizationContract.Keys.AudioMain] = "Master",
                    ...
                    [SettingsLocalizationContract.Keys.InputRebindCanceled] = "Key reassignment canceled.",
                    ...
                    [SettingsLocalizationContract.Keys.DisplayPreviewConfirmFullscreenBody] =
                        "Preview {0} x {1} in Borderless Fullscreen. These changes are temporary and will revert in {2} seconds unless you confirm.",
                    [SettingsLocalizationContract.Keys.DisplayPreviewConfirmWindowedBody] =
                ...
                [KoreanLocaleCode] = new Dictionary<string, string>
                {
                    ...
                    [SettingsLocalizationContract.Keys.DisplayTab] = "화면",
                    [SettingsLocalizationContract.Keys.InputTab] = "조작",
                    [SettingsLocalizationContract.Keys.AudioMain] = "전체 음량",
                    ...
                    [SettingsLocalizationContract.Keys.DisplayCurrent] = "현재 화면 설정",
                    ...
                    [SettingsLocalizationContract.Keys.InputReset] = "키 설정 초기화",
                    ...
                    [SettingsLocalizationContract.Keys.DisplayPreviewActiveStatus] = "화면 설정을 미리 적용했습니다. {0}초 안에 확인하지 않으면 이전 설정으로 돌아갑니다.",
                    [SettingsLocalizationContract.Keys.DisplayPreviewRevertedStatus] = "화면 설정이 이전에 저장된 값으로 돌아갔습니다.",
                    [SettingsLocalizationContract.Keys.DisplaySavedStatus] = "화면 설정이 저장되었습니다.",
                    [SettingsLocalizationContract.Keys.DisplayExternalDriftStatus] = "현재 화면 설정이 저장된 설정과 다릅니다. 다시 적용하기 전까지 저장된 설정은 변경되지 않습니다.",
                    [SettingsLocalizationContract.Keys.InputRebindCanceled] = "키 재지정을 취소했습니다.",
                    [SettingsLocalizationContract.Keys.InputResetComplete] = "키 설정을 초기화했습니다.",
                    ...
                    [SettingsLocalizationContract.Keys.InputAlreadyRebinding] = "이미 다른 키를 재지정하고 있습니다.",
                    ...
                    [SettingsLocalizationContract.Keys.InputRebindPushPrompt] = "밀기 키를 누르세요…",
                    [SettingsLocalizationContract.Keys.InputRebindFlipPrompt] = "뒤집기 키를 누르세요…",
                    [SettingsLocalizationContract.Keys.InputResetConfirmTitle] = "키 설정 초기화",
                    [SettingsLocalizationContract.Keys.InputResetConfirmBody] = "키 설정을 기본값으로 초기화할까요?",
            ...
            IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> catalog)
        {
            ...
            var stageEntries = new[]
            {
                ...
                (Key: "stage.stage-2-1.display_name", English: "Ward[A]-01", Korean: "A병동-01"),
                (Key: "stage.stage-2-2.display_name", English: "Ward[A]-02", Korean: "A병동-02"),
                (Key: "stage.stage-3-1.display_name", English: "Ward[B]-01", Korean: "B병동-01"),
                (Key: "stage.stage-3-2.display_name", English: "Ward[B]-02", Korean: "B병동-02"),
                (Key: "stage.stage-3-3.display_name", English: "Ward[B]-03", Korean: "B병동-03"),
                ...
                (Key: "stage.legacy-stage-5-1.display_name", English: "Legacy 5-1", Korean: "레거시 5-1"),
            };
