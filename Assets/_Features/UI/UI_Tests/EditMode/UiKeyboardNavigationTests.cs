...
namespace Game.Feature.UI.Tests
{
    public sealed class UiKeyboardNavigationTests
    {
            ...
            try
            {
                ...
                router.Initialize(
                    ...
                    new UiLayeredNavigationTargetResolver(
                        popupController,
                        null,
                        screenProvider: new FixedNavigationTargetProvider(mainMenu.View)),
                    () => false,
                    () => false);
        ...
        private sealed class FixedNavigationTargetProvider : IUiNavigationTargetProvider
        {
            private readonly IUiNavigationTarget _target;

            public FixedNavigationTargetProvider(IUiNavigationTarget target)
            {
                _target = target;
            }
