...
namespace Game.Feature.UI.Tests
{
    public sealed class UiGovernanceDocumentationTests
    {
        ...
        public void UiBaselineNote_RecordsPhaseOneCanonicalDriftCorrections_AndDeletionProtections()
        {
            ...
            Assert.That(resultSection, Does.Contain("Current Unity UI EditMode: `1440 total / 0 failed`"));
            Assert.That(resultSection, Does.Contain("result `1440 total / 0 failed`, failed tests `none`, failure category `none`"));
