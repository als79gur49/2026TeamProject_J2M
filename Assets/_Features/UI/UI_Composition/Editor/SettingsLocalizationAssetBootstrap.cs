...
namespace Game.Feature.UI.Composition.Editor
{
    public static class SettingsLocalizationAssetBootstrap
    {
        ...
        private static readonly (string Key, string English, string Korean, bool IsSmart)[] RequiredEntries =
        {
            ...
            (SettingsLocalizationContract.Keys.AudioMain, "Master", "마스터", false),
            ...
            (SettingsLocalizationContract.Keys.DisplayFullscreenWindow, "Borderless Fullscreen", "테두리 없는 전체 화면", false),
            ...
            (SettingsLocalizationContract.Keys.DisplayPreviewConfirmFullscreenBody, "Preview {0} x {1} in Borderless Fullscreen. These changes are temporary and will revert in {2} seconds unless you confirm.", "{0} x {1} 해상도로 테두리 없는 전체 화면을 미리 적용했습니다. 확인하지 않으면 {2}초 후 이전 설정으로 돌아갑니다.", true),
