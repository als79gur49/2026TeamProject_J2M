...
namespace Game.Feature.UI.Composition.Editor
{
    public static class SettingsLocalizationAssetBootstrap
    {
        ...
        private static readonly (string Key, string English, string Korean, bool IsSmart)[] RequiredEntries =
        {
            ...
            (SettingsLocalizationContract.Keys.InputRebindCanceled, "Key reassignment cancelled.", "키 재지정을 취소했습니다.", false),
            ...
            (SettingsLocalizationContract.Keys.InputAlreadyRebinding, "Another key is already being reassigned.", "다른 키를 이미 재지정하고 있습니다.", false),
            (SettingsLocalizationContract.Keys.InputActionConflict, "This key is already used by {0}.", "이 키는 이미 {0}에 사용 중입니다.", true),
            ...
            (SettingsLocalizationContract.Keys.InputResetConfirmBody, "Reset input settings to defaults?", "입력 설정 초기화 확인", false),
            ...
            (SettingsLocalizationContract.Keys.DisplayPreviewConfirmFullscreenBody, "Preview {0} x {1} in Fullscreen Window. These changes are temporary and will revert in {2} seconds unless you confirm.", "{0} x {1} 전체 화면 창 미리 보기. 변경은 임시이며 확인하지 않으면 {2}초 후 되돌아갑니다.", true),
            (SettingsLocalizationContract.Keys.DisplayPreviewConfirmWindowedBody, "Preview {0} x {1} in Windowed mode. These changes are temporary and will revert in {2} seconds unless you confirm.", "{0} x {1} 창 미리 보기. 변경은 임시이며 확인하지 않으면 {2}초 후 되돌아갑니다.", true),
            ...
            (SceneTransitionLocalizationContract.Keys.RemainingChances, "Remaining Chances", "재시도 기회", false),
            ...
            (MainMenuLocalizationContract.Keys.SlotChances, "Chances {0}", "기회 {0}", true),
            (MainMenuLocalizationContract.Keys.SlotDeaths, "Deaths {0}", "사망 {0}", true),
            (MainMenuLocalizationContract.Keys.SlotPlayed, "Played {0}", "최근 플레이 {0}", true),
            ...
            (MainMenuLocalizationContract.Keys.RestartTitle, "Restart Slot", "슬롯 다시 시작", false),
            (MainMenuLocalizationContract.Keys.RestartBody, "Restart slot {0} from the beginning?", "{0}번 슬롯을 처음부터 다시 시작할까요?", true),
            (MainMenuLocalizationContract.Keys.RestartWarning, "Existing progress will be replaced.", "기존 진행 상황은 교체됩니다.", false),
            ...
            (MainMenuLocalizationContract.Keys.OverwriteWarning, "Existing progress will be overwritten.", "기존 진행 상황은 덮어씌워집니다.", false),
