...
namespace Game.Feature.UI.Composition.Editor
{
    public static class SettingsLocalizationAssetBootstrap
    {
        ...
        private static readonly (string Key, string English, string Korean, bool IsSmart)[] RequiredEntries =
        {
            ...
            (SettingsLocalizationContract.Keys.DisplayFullscreenWindow, "Fullscreen Window", "테두리 없는 전체 화면", false),
            ...
            (SettingsLocalizationContract.Keys.InputAlreadyRebinding, "Another key is already being reassigned.", "다른 키를 설정하는 중입니다.", false),
            ...
            (SettingsLocalizationContract.Keys.InputRebindPushPrompt, "Press a key for Push...", "밀기에 사용할 키를 누르세요...", false),
            (SettingsLocalizationContract.Keys.InputRebindFlipPrompt, "Press a key for Flip...", "뒤집기에 사용할 키를 누르세요...", false),
            ...
            (SettingsLocalizationContract.Keys.DisplayPreviewConfirmFullscreenBody, "Preview {0} x {1} in Fullscreen Window. These changes are temporary and will revert in {2} seconds unless you confirm.", "{0} x {1} 해상도로 테두리 없는 전체 화면을 미리 적용했습니다. 확인하지 않으면 {2}초 후 이전 설정으로 돌아갑니다.", true),
            (SettingsLocalizationContract.Keys.DisplayPreviewConfirmWindowedBody, "Preview {0} x {1} in Windowed mode. These changes are temporary and will revert in {2} seconds unless you confirm.", "{0} x {1} 해상도로 창 모드를 미리 적용했습니다. 확인하지 않으면 {2}초 후 이전 설정으로 돌아갑니다.", true),
