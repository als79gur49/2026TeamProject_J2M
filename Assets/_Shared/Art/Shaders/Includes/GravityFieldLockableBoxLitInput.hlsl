#ifndef GRAVITY_FIELD_LOCKABLE_BOX_LIT_INPUT_INCLUDED
#define GRAVITY_FIELD_LOCKABLE_BOX_LIT_INPUT_INCLUDED
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4, _InactiveTint)
    UNITY_DOTS_INSTANCED_PROP(float4, _GravityFieldLockedTint)
...
static float4 unity_DOTS_Sampled_InactiveTint;
static float4 unity_DOTS_Sampled_GravityFieldLockedTint;
...
void SetupDOTSLitMaterialPropertyCaches()
{
    ...
    unity_DOTS_Sampled_InactiveTint         = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4, _InactiveTint);
    unity_DOTS_Sampled_GravityFieldLockedTint = UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4, _GravityFieldLockedTint);
...
#define _InactiveTint           unity_DOTS_Sampled_InactiveTint
#define _GravityFieldLockedTint unity_DOTS_Sampled_GravityFieldLockedTint
...
void ApplyGravityFieldLockedSurfaceData(inout SurfaceData surfaceData, float2 uv)
{
    ...
    half dimFactor = saturate(_GravityFieldDimFactor);
    half tintStrength = saturate(_GravityFieldTintStrength);
    half3 dimmedColor = surfaceData.albedo * dimFactor;
    half3 tintedColor = lerp(
        dimmedColor,
...
#endif // GRAVITY_FIELD_LOCKABLE_BOX_LIT_INPUT_INCLUDED
