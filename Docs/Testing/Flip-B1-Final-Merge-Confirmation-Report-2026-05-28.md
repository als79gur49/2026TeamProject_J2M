...
- Hit timing contract: authoritative hit/damage/death is anchored to the action-normalized visual impact due tick, `ActionStartTick + RoundToInt(FlipInputLockDurationTicks * 0.936)`, not the old 6 tick onset or execute-tick offset.
