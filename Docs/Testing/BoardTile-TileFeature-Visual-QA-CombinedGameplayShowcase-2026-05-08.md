...
- `button.default`: `Button`, `Overlay`, default for kind.
- `button.moon-only`: `Button`, `Overlay`.
...
- `910`: `SurfaceCell(face=0,x=10,y=1)`, `Button`, key `button.default`.
...
- `SurfaceCell(face=0,x=10,y=1)`: `destroy.default` plus same-cell overlay `button.default`.
...
- `SurfaceCell(face=0,x=10,y=1)`: same-cell overlay button over replace destroy.
