...
- 현재 기준점은 다음과 같다.
  ...
  - `./run_tests.sh ui`: green on 2026-06-12 KST, Windows `dotnet build Game.Feature.UI.Tests.csproj -c Debug` passed with `0` errors, Unity UI EditMode `690 total / 0 failed`
