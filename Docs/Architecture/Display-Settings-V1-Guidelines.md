...
- Settings authored child-view canonicalization and migration helper cleanup are complete. Future prefab authoring changes should edit canonical prefab assets directly and rely on prefab contract tests.
