...
- result carrier provenance naming
  ...
  - `DamageResolutionRecord.GroupId`, `DestroyResolutionRecord.GroupId`, `DelayedAttackEffectRecord.SourceActionGroupId`는 제거된 compatibility alias이며 새 runtime reader는 읽지 않는다.
