...
$script:RequiredThirdPartyNoticeFragments = @(
    ...
    "Noto Sans JP / Noto Sans SC`n`nStyles included: JP Regular, JP Bold, SC Regular, SC Bold",
    "Copyright 2014-2021 Adobe (http://www.adobe.com/).`nNoto is a trademark of Google Inc.",
    "Source: https://github.com/notofonts/noto-cjk",
    "static TextMesh Pro SDF rendering assets generated from`nthe listed font software.",
    ...
    "On 2026-09-23 KST, the project release`nowner confirmed that the required KBO/KBOP clearance",
    "The private rights`nevidence ledger, rather than this public summary, is the authority",
    "This confirmation does not permit standalone font sales, source TTF`nmodification, CI / BI use",
